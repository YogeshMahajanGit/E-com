  ...
  return productData ? (
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1  mix-blend-plus-darker">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 text-sm border px-6 py-6 text-gray-500 ">
          <p>
            ...
            wesites have gained immense popularity due to their convenience,
            accessiblity, and the global they offer.
          </p>
          <p>
            E-commerce wesites typically display product or services along with
            detailed description, image, prices. and any available
